...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/boss-alix/escadron-MD/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/boss-alix/escadron-MD';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ᴀʟɪ-ᴍᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ escadron-mᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
...
*ᴜsᴇ .ᴜᴘᴅᴀᴛᴇ ᴛᴏ ᴜᴘᴅᴀᴛᴇ.*`;
    ...
    await conn.sendMessage(from, {
      image: { url: 'https://files.catbox.moe/inu6r8.jpg' },
