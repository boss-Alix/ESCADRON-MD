...
const REPO_OWNER = 'boss-alix';
const REPO_NAME = 'escadron-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *escadron MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*escadron MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/h73meo.jpg` }, // Replace with your image URL
