...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "https://files.catbox.moe/h73meo.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩ု᪳ℰ𝒮𝒞𝒜𝒟ℛ𝒪𝒩᪳𓆪";
            const imageUrl = "https://files.catbox.moe/h73meo.jpg"; // Replace with the actual image URL
