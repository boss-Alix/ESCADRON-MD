...
cmd({
  ...
  try {
    if (!q) {
      return reply("*‼️ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠ𝖾𝗌𝖼𝖺𝖽𝗋𝗈𝗇－𝗆𝖽 ᴍᴇᴅɪᴀғɪʀᴇ ʟɪɴᴋ.*");
    }
  ...
  try {
    ...
    if (downloadUrl) {
      ...
      await conn.sendMessage(from, {
        ...
        caption: "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝖾𝗌𝖺𝖼𝖽𝗋𝗈𝗇－ᴍᴅ🎐*"
      }, { quoted: m });
